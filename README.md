...
<title>Pamela, Will You Be My Valentine? 💖</title>
...
function accept() {
    document.getElementById("card").innerHTML = `
        ...
        <p style="font-size:1.1rem; line-height:1.5;">
            Pamela, thank you for choosing me.<br>
...
// NO button playful trick (smooth dodge)
...
noBtn.addEventListener('mouseenter', () => {
    ...
    let y = Math.random() * (60 - btnHeight); // inside container div height
